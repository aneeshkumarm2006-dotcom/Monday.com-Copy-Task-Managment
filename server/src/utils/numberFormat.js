 ...
 *
 * Duplicated on the client as `client/src/utils/numberFormat.js` — the cell
 * renders there and the group totals and exports render here, and they have to
 * agree. `numberFormat.test.js` is the tripwire that says so.
 */
 ...
 * @returns {string}
 */
const formatNumber = (value, settings = {}) => {
