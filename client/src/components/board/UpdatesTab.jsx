...
// Re-exported so the four call sites that already import it from here
// (GroupNotesPanel, RichItem, ChatPage, and this file) keep working. The
// implementation moved to its own module so the Client Portal can render
// rich text without importing this file's app-authenticated services.
export { default as ReadOnlyRichBody } from './ReadOnlyRichBody';
